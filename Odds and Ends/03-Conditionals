...
Write code that allows the user to input "yes" or "no".
If the user inputs "yes" your program should output "true".
If the user inputs "no" your program should output "false".
